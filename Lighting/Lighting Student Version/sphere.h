...
public:
    ...
    float shininess;
    // ctor/dtor
    Sphere(float radius = 1.0f, int sectorCount = 36, int stackCount = 18, glm::vec3 amb = glm::vec3(1.0f, 0.0f, 0.0f), glm::vec3 diff = glm::vec3(1.0f, 0.0f, 0.0f), glm::vec3 spec = glm::vec3(0.5f, 0.5f, 0.5f), glm::vec3 emmi = glm::vec3(0.1f, 0.0f, 0.0f) , float shiny = 32.0f) : verticesStride(24)
    {
        set(radius, sectorCount, stackCount, amb, diff, spec, emmi , shiny);
    ...
    void set(float radius, int sectors, int stacks, glm::vec3 amb, glm::vec3 diff, glm::vec3 spec, glm::vec3 emmi, float shiny)
    {
        if (radius > 0)
            this->radius = radius;
    ...
    void drawSphere(Shader& lightingShader, glm::mat4 model) const      // draw surface
    {
        ...
        lightingShader.setVec3("material.emmisive", this->emmisive);
